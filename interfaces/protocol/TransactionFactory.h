...
public:
    ...
    virtual Transaction::Ptr createTransaction(int32_t _version, bytes const& _to,
        bytes const& _input, u256 const& _nonce, int64_t _blockLimit,
        std::string const& _chainId, std::string const& _groupId, int64_t _importTime) = 0;
    virtual Transaction::Ptr createTransaction(int32_t _version, bytes const& _to,
        bytes const& _input, u256 const& _nonce, int64_t _blockLimit,
        std::string const& _chainId, std::string const& _groupId, int64_t _importTime, bcos::crypto::KeyPairInterface::Ptr keyPair) = 0;

...
BlockHeader::Ptr fakeAndTestBlockHeader(CryptoSuite::Ptr _cryptoSuite, int32_t _version,
...
ParentInfoListPtr fakeParentInfo(Hash::Ptr _hashImpl, size_t _size)
{
...
SignatureListPtr fakeSignatureList(
...
void testPBBlockHeader(CryptoSuite::Ptr _cryptoSuite)
{
